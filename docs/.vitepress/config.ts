...
export default defineConfig({
  ...
  themeConfig: {
    editLink: {
      pattern: "https://github.com/Liu2000fx/dozzle_ks/edit/master/docs/:path",
    },
    nav: [
      { text: "Home", link: "/" },
      { text: "Guide", link: "/guide/what-is-dozzle", activeMatch: "/guide/" },
      {
        ...
        items: [
          {
            text: "Releases",
            link: "https://github.com/Liu2000fx/dozzle_ks/releases",
          },
          {
            text: "New Issue",
            link: "https://github.com/Liu2000fx/dozzle_ks/issues/new/choose",
          },
        ],
      },
    ],
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/Liu2000fx/dozzle_ks" },
      {
        icon: {
